...
class Ui_PlayerControls(object):
    def setupUi(self, PlayerControls):
        ...
        self.frame_3.setStyleSheet("background-color: rgb(209, 209, 214);\n"
"color: rgb(13, 17, 19);")
        ...
        self.play.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../waffwhale/widgets/icons/play.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
